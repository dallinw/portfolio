  ...
  ***************************************************/
  ...
  function handleSubmit(event) {
    ...
    if(!isValidEmail(email)) 
    {
      ...
      sendFeedback(TEMPLATE_ID, {message_html: feedback, toName: toName, fromName: fromName, reply_to: email})
      setFeedback('');
      setFromName('');
      setEmail('');
      }
  ...
  function handleMessageChange(event){ setFeedback(event.target.value); }
